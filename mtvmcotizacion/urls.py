...
urlpatterns = patterns('',  # C0103: El error es la forma del nombre urlpatterns pero no se puede corregir
                       url(r'^',
                           include('inicio.urls', namespace='uinicio')),
                       url(r'^admin/',
                       ...
                       url(r'^contenido/',
                           include('contenido.urls', namespace="ucontenidos")),
                       url(r'^cotizacion/',
                           include('cotizacion.urls', namespace="ucotizaciones")),
                       url(r'^direccion/',
                           include('direccion.urls', namespace="udirecciones")),
                       url(r'^mueble/',
                           include('mueble.urls', namespace="umuebles")),
                       url(r'^presupuesto/',
                           include('presupuesto.urls', namespace="upresupuestos")),
                       url(r'^servicio/',
