...
urlpatterns = patterns('',
                       ...
                       url(r'^complejidad_servicio/nuevo/(?P<id_ser>\d+)/', views.add_complejidadservicio,
                       ...
                       url(r'^unidad/$', views.lista_unidad, name='lista_unidad'),
                       url(r'^unidad/nuevo', views.add_unidad, name='add_unidad'),
                       url(r'^unidad/editar/(?P<pk>\d+)/$', views.edit_unidad,
                           name='edit_unidad'),
                       )
