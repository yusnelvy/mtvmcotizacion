...
urlpatterns = patterns('',
                       ...
                       url(r'^email/nuevo/(?P<id_cli>\d+)/$', views.add_email, name='add_email'),
                       url(r'^sexo/$', views.lista_sexo, name='lista_sexo'),
                       url(r'^sexo/nuevo/$', views.add_sexo, name='add_sexo'),
                       url(r'^sexo/editar/(?P<pk>\d+)/$', views.edit_sexo, name='edit_sexo'),
                       ...
                       url(r'^estado_civil/editar/(?P<pk>\d+)/$', views.edit_estado_civil,
                       ...
                       url(r'^cliente_ficha/(?P<pk>\d+)/$', views.ficha_cliente,
                           name='ficha_cliente'),
                       url(r'^cliente_ficha/(?P<id_cli>\d+)/email/delete/$', views.delete_email,
                           name='delete_email'),
                       url(r'^cliente_ficha/(?P<id_cli>\d+)/direccion/delete/$', views.delete_direccion,
                           name='delete_direccion'),
                       url(r'^cliente_ficha/(?P<id_cli>\d+)/telefono/delete/$', views.delete_telefono,
