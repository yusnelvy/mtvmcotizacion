...
urlpatterns = patterns('',
                       ...
                       url(r'^cliente_ficha/(?P<id_cli>\d+)/email/delete/(?P<pk>\d+)$', views.delete_email,
                           name='delete_email'),
                       url(r'^cliente_ficha/(?P<id_cli>\d+)/direccion/delete/(?P<pk>\d+)$', views.delete_direccion,
                           name='delete_direccion'),
                       url(r'^cliente_ficha/(?P<id_cli>\d+)/telefono/delete/(?P<pk>\d+)$', views.delete_telefono,
