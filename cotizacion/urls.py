...
urlpatterns = patterns('',
                       ...
                       url(r'^cotizacion_direccion/nuevo/(?P<idcotizacion>\d+)/', views.add_cotizaciondireccion,
                       ...
                       url(r'^cotizacion_trabajador/nuevo/(?P<idcotizacion>\d+)/', views.add_cotizaciontrabajador,
                       ...
                       url(r'^cotizacion_ambiente/nuevo/(?P<idcotizacion>\d+)/', views.add_cotizacionambiente,
                       ...
                       url(r'^cotizacion_mueble/nuevo/(?P<idcotizacionambiente>\d+)/', views.add_cotizacionmueble,
                       ...
                       url(r'^cotizacion_servicio/nuevo/(?P<idcotizacionmueble>\d+)/$', views.add_cotizacionservicio,
                           name='add_cotizacionservicio'),
                       url(r'^cotizacion_servicio/nuevo/(?P<idcotizacionmueble>\d+)/(?P<idcotizacioncontenido>\d+)/$',
                       ...
                       url(r'^cotizacion_material/nuevo/(?P<idcotizacionservicio>\d+)/$', views.add_cotizacionmaterial,
